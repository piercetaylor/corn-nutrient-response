# Previous README: corn nutrient response in Nebraska

This is the full README that preceded the shorter repository overview. It is retained as a historical document; the [current README](../README.md) is the entry point for the project.
